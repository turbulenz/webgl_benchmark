...
var CascadedShadowMapping = (function () {
    ...
    CascadedShadowMapping.prototype.updateShadowMap = function (lightDirection, camera, scene, maxDistance) {
        ...
        var sideCamera = this._updateSideCamera(cameraRight, cameraUp, cameraAt, direction, frustumPoints);
        ...
        for (n = 0; n < numSplits; n += 1) {
            ...
            frustumPoints = this._getSideCameraFrustumPoints(splitEnd, splitStart, frustumPoints, camera, maxDistance);
    ...
    CascadedShadowMapping.prototype._updateSideCamera = function (cameraRight, cameraUp, cameraAt, lightDirection, frustumPoints) {
        var md = this.md;
    ...
    CascadedShadowMapping.prototype._getSideCameraFrustumPoints = function (endDistance, startDistance, frustumPoints, mainCamera, maxDistance) {
        var nearPlane = this.sideCameraNearPlane;
    ...
    CascadedShadowMapping.prototype._updateSplit = function (split, xaxis, yaxis, zaxis, mainCameraMatrix, frustumPoints, previousSplitPoints, scene, maxDistance) {
        ...
        if (frustumUpdated || numStaticOverlappingRenderables !== numOverlappingRenderables) {
            ...
            var numOccluders = this._filterOccluders(overlappingRenderables, overlappingExtents, numOverlappingRenderables, occludersDrawArray, occludeesExtents, occludersExtents, (scene.frameIndex - 1));
    ...
    CascadedShadowMapping.prototype._filterOccluders = function (overlappingRenderables, overlappingExtents, numOverlappingRenderables, occludersDrawArray, occludeesExtents, occludersExtents, frameIndex) {
        var numOccludees = 0;
        var numOccluders = 0;
